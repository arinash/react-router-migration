...
import { cardsData } from '../../data/header';

import jetBrainsLogo from '../../../public/assets/images/jetbrains-logo.svg';
                ...
                <div className="header-section__actions">
                    ...
                    <div className="header-section__contributors">
                        ...
                        <p className={textCn('rs-text-2')}>
                            Developed by{' '}
                            <a className={textCn('rs-link')} href="https://www.jetbrains.com/">JetBrains</a> 
                            {' & Open-source '}
                            <a className={textCn('rs-link')} href="https://github.com/JetBrains/kotlin/graphs/contributors">
                                Contributors
                            </a>
                        </p>
                    </div>
